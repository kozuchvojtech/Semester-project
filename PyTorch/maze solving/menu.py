...
class intro:
    ...
    def game_intro(self):
        ...
        while intro:
            ...
            textSurf, textRect = text_object('Maze solving', textFont, greyColour)
    ...
    def AI_option(self):
        ...
        while intro:
            ...
            button(self.playSurface,'test', self.display_width//4*3, self.display_height//8*7, self.display_width//8, self.display_height//8, redColour, brightRedColour, test)
